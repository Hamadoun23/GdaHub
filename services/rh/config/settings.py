"""Reglages du service rh — Ressources humaines.
...
INSTALLED_APPS = [*INSTALLED_APPS, "gdahub_common.validation", "rh"]

MEDIA_ROOT = BASE_DIR / "media"
STATIC_ROOT = BASE_DIR / "staticfiles"

# Les services que celui-ci a le droit d'appeler, via gdahub_common.client.
# Un seul, et un seul appel : l'annuaire, au moment ou une demande est
# deposee. Tout le reste se lit en local.
